...
G1_WBC_TASKS: tuple[WbcTaskConfig, ...] = (
  ...
  WbcTaskConfig(
    task_id="Wbc-G1-SE",
    robot_id="g1",
    description="Wbc-G1 + SE obs (ref anchor xyz/ori, measured root pose, base lin vel).",
  ...
  WbcTaskConfig(
    ...
    robot_id="g1",
    description="Zest + SE obs (ref anchor xyz/ori, measured root pose, base lin vel).",
